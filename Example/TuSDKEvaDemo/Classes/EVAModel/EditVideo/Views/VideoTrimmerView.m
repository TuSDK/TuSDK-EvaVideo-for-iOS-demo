...
- (void)layoutSubviews {
	...
	_trimmerMaskView.maskRect = CGRectMake(thumbnailsWidth * self.startProgress, _trimmerMaskView.maskRect.origin.y, thumbnailsWidth * self.endProgress - thumbnailsWidth * self.startProgress, _trimmerMaskView.maskRect.size.height);
